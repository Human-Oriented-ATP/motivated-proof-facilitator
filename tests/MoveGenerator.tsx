...
const styles: Record<string, React.CSSProperties> = {
  ...
  primaryButton: {
    padding: "10px 20px",
    background: "linear-gradient(180deg, #2e4a68, #1e3a5f)",
    color: "white",
    border: "none",
    borderRadius: "8px",
    fontSize: "14px",
    ...
    boxShadow: "0 2px 4px rgba(30,60,110,0.15)",
    marginRight: "8px",
  },
  secondaryButton: {
    padding: "10px 20px",
    ...
    boxShadow: "0 1px 3px rgba(30,60,110,0.05)",
    marginRight: "8px",
  },
  tertiaryButton: {
    padding: "10px 20px",
  ...
  proofStateSection: {
    ...
    borderRadius: "10px",
    border: "1px solid #E2E8F0",
    boxShadow: "0 2px 8px rgba(30,60,110,0.04)",
  },
  sectionHeading: {
    fontSize: "16px",
    fontWeight: "600",
