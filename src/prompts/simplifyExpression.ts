...
export const simplifyExpressionMove: ProofDiscoveryMove = {
  ...
  "kind": "equivalence",
  "trigger": "This move is relevant when the proof state has a single selected expression or statement, ideally representing a complex term that can be simplified.",
