export const unfoldDefinitionMove = {
  ...
  "action": "This move unfolds the selected definition and replaces it with an equivalent expression, usually conceptually simpler than the original. When there are multiple possibilities, definitions at a higher level of abstraction are favoured.",
  "examples": [
    {
      "description": "",
      "inputState": {
